...
Процедура ПриОткрытии(Отказ)
	...
	мФормаОсобогоТипа = ПолучитьФорму(ПутьКФормам + "ФормаОсобогоТипаУ");
...
Процедура ПолеРезультатаЗапросаОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	Если ТипЗнч(Расшифровка) = Тип("ТабличныйДокумент") Тогда
		...
		ФормаВложеннойТаблицы = ПолучитьФорму(ПутьКФормам + "ФормаВложеннойТаблицыУ");
...
Функция ВызовВыполнитьЗапрос(ТекстЗапроса, ПараметрыЗапроса, СпособВыгрузки)
	Возврат ПолучитьОбработку().ВыполнитьЗапросУ(ТекстЗапроса, ПараметрыЗапроса, СпособВыгрузки, СоставРезультатов, ДляСсылокВыводитьГУИД);
КонецФункции
